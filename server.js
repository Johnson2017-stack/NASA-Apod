...
const prevPicUrl = 'https://api.nasa.gov/planetary/apod?api_key=VLXRS1OhKA4gEpO1t9tPPU5cWWLU7ps8ousjyZiG&start_date=2023-05-25&end_date=2023-06-17'
...
server.get('/prev-pic', (req, res) => {
    ...
    .then((data) => {
        ...
        res.render("prev-pic", {nasaData: prevPicArr})
    })
})
